...
const AssetStetting = () => {
  ...
  const [data, setData] = useState({ step: 10, index: 1, TotalPage: 1, employees: [] });
  ...
  const getData = () => {
    ...
    fetch(`${process.env.REACT_APP_API_URL}/api/employee/list`, {
      method: "POST",
      headers: {
      ...
      },
      {
        ...
        Cell: ({ row }) => (
          <Dropdown className="float-end" align="end">
            ...
            <Dropdown.Menu>
              <Dropdown.Item onClick={() => navigate('/employee/detail/' + row.original.id)}>
                View
              </Dropdown.Item>
              <Dropdown.Item onClick={() => navigate('/employee/update/' + row.original.id)}>
                Update
              </Dropdown.Item>
              <Dropdown.Item onClick={() => navigate('/employee/delete/' + row.original.id)}>
                Delete
              </Dropdown.Item>
            </Dropdown.Menu>
          </Dropdown>
