...
// components
import LayoutMode from "../../components/ThemeCustomizer/LayoutMode";
import LayoutTypes from "../../components/ThemeCustomizer/LayoutTypes";
...
import MenuPositions from "../../components/ThemeCustomizer/MenuPositions";
import LeftSideBarTheme from "../../components/ThemeCustomizer/LeftSideBarTheme";
import LeftSideBarType from "../../components/ThemeCustomizer/LeftSideBarType";
import TwoToneIcons from "../../components/ThemeCustomizer/TwoToneIcons";
import SidebarUserInfo from "../../components/ThemeCustomizer/SidebarUserInfo";
import TopbarTheme from "../../components/ThemeCustomizer/TopbarTheme";
import TwoColumnTheme from "../../components/ThemeCustomizer/TwoColumnTheme";
...
const ThemeCustomizer = () => {
  ...
  // const [disableTwoToneIcons, setDisableTwoToneIcons] = useState(false);
  const [disableSidebarUser, setDisableSidebarUser] = useState(false);
  const [disableLayoutMode, setDisableLayoutMode] = useState(false);
  const [showTwoColumnTheme, setShowTwoColumnTheme] = useState(false);
  ...
  const changeTwoColumnTheme = (value) => {
    var layout = value;
    switch (layout) {
      case "light":
        dispatch(
   ...
   */
  const toggleTwoToneIconsMode = (value) => {
    var checked = value;
