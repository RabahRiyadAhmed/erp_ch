...
interface TableProps {
  ...
  tableClass?: string;
  theadClass?: string;
  onRowClick?: (row: any) => void; // Fonction callback à ajouter ici
}
...
const Table = (props: TableProps) => {
  ...
  const onRowClick = props["onRowClick"]; // Fonction callback passée en prop
          ...
          <tbody {...dataTable.getTableBodyProps()}>
            {(rows || []).map((row: any, i: number) => {
              ...
              return (
                <tr
                  {...row.getRowProps()}
                  onClick={() => onRowClick && onRowClick(row)} // Ajouter un gestionnaire de clic
                >
